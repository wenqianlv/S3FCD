...
class SiameseUnetConc(nn.Module):
    ...
    def __init__(self, input_nbr=3, label_nbr=2, name="siamese_unet_conc"):
        super(SiameseUnetConc, self).__init__()
        self.name = name
...
def siamese_unet_conc():
    net = SiameseUnetConc(name='siamese_unet_conc')
    return net
